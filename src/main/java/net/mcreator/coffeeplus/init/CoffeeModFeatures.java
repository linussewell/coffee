...
public class CoffeeModFeatures {
	...
	public static final RegistryObject<Feature<?>> COFFEE_TREE_SPAWN = register("coffee_tree_spawn", CoffeeTreeSpawnFeature::feature,
			new FeatureRegistration(GenerationStep.Decoration.SURFACE_STRUCTURES, CoffeeTreeSpawnFeature.GENERATE_BIOMES,
					CoffeeTreeSpawnFeature::placedFeature));
