...
public class CoffeeplusModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(CoffeeTreeSpawnFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.SURFACE_STRUCTURES,
				CoffeeTreeSpawnFeature.GENERATE_BIOMES, CoffeeTreeSpawnFeature.CONFIGURED_FEATURE));
	}
