...
public class CoffeeplusModPotions {
	private static final List<Potion> REGISTRY = new ArrayList<>();
	public static final Potion INSOMNIA = register(
			new Potion(new MobEffectInstance(CoffeeplusModMobEffects.INSOMNIA, 3600, 0, false, true)).setRegistryName("insomnia"));
