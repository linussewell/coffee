...
package net.mcreator.coffeeplus.world.inventory;
...
public class GrindingGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GrindingGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CoffeeModMenus.GRINDING_GUI, id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 34, 26) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (CoffeeModItems.ROASTED_COFFEE_BEAN.get() == stack.getItem());
			}
		}));
