...
import net.mcreator.coffeeplus.gui.GrinderGUIGui;
...
public class CoffeeGrinderBlock extends CoffeeplusModElements.ModElement {
	@ObjectHolder("coffeeplus:coffee_grinder")
	public static final Block block = null;

	public CoffeeGrinderBlock(CoffeeplusModElements instance) {
		super(instance, 55);
	}
