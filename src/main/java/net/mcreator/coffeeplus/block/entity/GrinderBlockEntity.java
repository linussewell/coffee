...
public class GrinderBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public GrinderBlockEntity(BlockPos position, BlockState state) {
		super(CoffeeModBlockEntities.GRINDER.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new GrindingGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
