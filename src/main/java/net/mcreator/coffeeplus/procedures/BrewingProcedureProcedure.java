...
public class BrewingProcedureProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if ((new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 0)).getItem() == CoffeeModItems.GROUND_COFFEE.get() && (new Object() {
			public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				BlockEntity _ent = world.getBlockEntity(pos);
				if (_ent != null)
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 1)).getItem() == CoffeeModItems.MUG.get() && (new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 2)).getItem() == CoffeeModItems.FULL_COFFEE_MUG.get())) {
			{
			...
			}
			{
				...
				if (_ent != null) {
					final int _slotid = 2;
					final ItemStack _setstack = new ItemStack(CoffeeModItems.FULL_COFFEE_MUG.get());
