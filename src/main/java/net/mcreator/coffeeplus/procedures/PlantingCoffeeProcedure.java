	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.GRASS_BLOCK) {
			if (true) {
				...
				world.setBlock(BlockPos.containing(x, y + 1, z), CoffeeModBlocks.COFFEE_TREE_STAGE_0.get().defaultBlockState(), 3);
				if (new Object() {
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == CoffeeModItems.RAW_COFFEE_BEAN.get()
