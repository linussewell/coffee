...
public class CoffeeTreeStage2OnBlockRightClickedProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BONE_MEAL) == false) {
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == CoffeeModBlocks.COFFEE_TREE_STAGE_3.get()) {
				if (!world.isClientSide()) {
					randomNumber = Math.random();
					if (randomNumber >= 0.66) {
						for (int index0 = 0; index0 < 3; index0++) {
							if (world instanceof ServerLevel _level) {
								ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.05), (y + 0.05), (z + 0.05), new ItemStack(CoffeeModItems.RAW_COFFEE_BEAN.get()));
				...
				if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == CoffeeModBlocks.COFFEE_TREE_STAGE_2.get()) {
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.05), (y + 0.05), (z + 0.05), new ItemStack(CoffeeModItems.RAW_COFFEE_BEAN.get()));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == CoffeeModBlocks.COFFEE_TREE_STAGE_2.get()) {
				...
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.COMPOSTER, x, y, z, 10, 0.5, 0.5, 0.5, 1);
			...
			} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == CoffeeModBlocks.COFFEE_TREE_STAGE_3.get()) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = CoffeeModBlocks.COFFEE_TREE_STAGE_1.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);
			...
			} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == CoffeeModBlocks.COFFEE_TREE_STAGE_0.get()) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = CoffeeModBlocks.COFFEE_TREE_STAGE_1.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);
