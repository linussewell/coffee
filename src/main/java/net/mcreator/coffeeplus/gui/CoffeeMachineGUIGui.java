...
public class CoffeeMachineGUIGui extends CoffeeplusModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public CoffeeMachineGUIGui(CoffeeplusModElements instance) {
		super(instance, 22);
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 34, 26) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (GroundCoffeeItem.block == stack.getItem());
				}
			}));
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 34, 53) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (MugItem.block == stack.getItem());
				}
			}));
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				CoffeeplusMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			BrewingProcedureProcedure.executeProcedure(Stream
