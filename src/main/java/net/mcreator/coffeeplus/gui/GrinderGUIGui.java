...
public class GrinderGUIGui extends CoffeeplusModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public GrinderGUIGui(CoffeeplusModElements instance) {
		super(instance, 58);
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			GrindingProcedureProcedure.executeProcedure(Stream
